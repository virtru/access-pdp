...
_ATTRIBUTEINSTANCE = DESCRIPTOR.message_types_by_name['AttributeInstance']
_ATTRIBUTEDEFINITION = DESCRIPTOR.message_types_by_name['AttributeDefinition']
AttributeInstance = _reflection.GeneratedProtocolMessageType('AttributeInstance', (_message.Message,), {
  'DESCRIPTOR' : _ATTRIBUTEINSTANCE,
  '__module__' : 'attributes.v1.attributes_pb2'
  # @@protoc_insertion_point(class_scope:attributes.v1.AttributeInstance)
  })
_sym_db.RegisterMessage(AttributeInstance)
...
AttributeDefinition = _reflection.GeneratedProtocolMessageType('AttributeDefinition', (_message.Message,), {
  ...
  '__module__' : 'attributes.v1.attributes_pb2'
  # @@protoc_insertion_point(class_scope:attributes.v1.AttributeDefinition)
  })
